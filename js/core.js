  ...
  const RULES = {
    ...
    thief: {
        ...
        <ul>
            ...
            <li><strong>카드 뽑기:</strong> 상대 카드를 클릭하여 선택(위로 올라감) → <strong>🃏 카드 뽑기</strong> 버튼 클릭.</li>
    ...
    onecard: {
        ...
        <ul>
            ...
            <li><strong>컬러 조커(C)</strong>: +7장 (빨간색으로 강조)</li>
        ...
        <ul>
            ...
            <li>누군가 카드를 뽑거나 내서 1장 상황이 해소되면 버튼 자동 비활성화.</li>
        </ul>
        <h3>서바이벌 룰 (게임 종료)</h3>
        <ul>

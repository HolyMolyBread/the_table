  ...
  const RULES = {
    ...
    blackjack: {
        ...
        <h3>PVP 레이드 (보스 레이드)</h3>
        <ul>
            <li>다수의 플레이어가 <strong>합산된 딜러 하트</strong>를 함께 깎는 협동 모드입니다.</li>
    ...
    sevenpoker: {
        ...
        <ul>
            ...
            <li>참가비 지불 후 별이 0개가 되어도 해당 라운드는 끝까지 진행 가능 (올인)</li>
        </ul>
        <h3>카드 분배 (3~7구)</h3>
        <ul>
    ...
    onecard: {
        ...
        <h3>서바이벌 룰 (게임 종료)</h3>
        <ul>
            <li><strong>4인</strong>: 2명 탈출 또는 2명 파산 시 종료.</li>
            <li><strong>3인</strong>: 1명 탈출 또는 2명 파산 시 종료.</li>
            <li><strong>2인</strong>: 1명 탈출 또는 1명 파산 시 종료.</li>
            <li>탈출 성공자와 파산하지 않은 생존자는 모두 <strong>승리</strong>, 파산자는 <strong>패배</strong>.</li>
        </ul>
        <h3>파산</h3>
        <ul>

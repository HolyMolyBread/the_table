...
| 도둑잡기 | `plugin_thief.go` | **완료** | 2~4인, 53장(52+조커) 페어 제거. **카드 선택 후 뽑기 버튼 클릭** UX. 접두사: `thief` |
| 원카드 | `plugin_onecard.go` | **완료** | 2~4인, 탑 카드 매칭, J=스킵 Q=방향반전. **서바이벌 룰**: 4인 2승2패, 3인 1승2패, 2인 1승1패 종료. 등수별 전적 기록(탈출/생존=승, 파산=패). C_JOKER 빨간색 강조. 접두사: `onecard` |

...
| **Phase 8.7** | **UI/UX 통합 및 시야 확보 패치** — 결과창 통합(unified-result-box), 블랙잭 결과 오버레이 분리, 홀덤 딜러 배지(DealerId), 인디언 포커 카드 렌더링 최적화·포기 공지, 도둑잡기 툴팁 제거, room-controls z-index/위치 조정, 원카드·마작 테이블 여백 및 패 간격 최적화 | 완료 |

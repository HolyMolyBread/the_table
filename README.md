...
| 게임 | 인원 | 비고 |
|------|------|------|
| 블랙잭 | 1 vs 딜러 / PVP 레이드 | PVE, PVP 보스 레이드(협동), 전원 준비 시스템 |
| 텍사스 홀덤 | 2~4인 | 별 서바이벌, 참가비(Ante), 올인(0별) 지원, DeltaStars 표시 |
| 세븐 포커 | 2~4인 | 4장 초이스, 히든 카드, 참가비(Ante), 올인 지원 |
| 인디언 포커 | 1:1 | 하트 서바이벌 |
| 도둑잡기 | 2~4인 | 53장, 페어 제거, 선택→버튼 뽑기 UX |
| 원카드 | 2~4인 | 탑 카드 매칭, 서바이벌 룰(탈출/파산), C_JOKER 빨간색 강조 |

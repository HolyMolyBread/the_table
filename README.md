...
- **상대적 좌석 배치**: 모든 게임에서 본인이 항상 화면 하단 중앙에 오도록 자동 회전
- **다크 모드 최적화**: 흑돌/백돌 시인성, 카드 배경·테두리 개선
...
| 게임 | 인원 | 비고 |
|------|------|------|
| 블랙잭 | 1 vs 딜러 / PVP 레이드 | PVE, PVP 보스 레이드(협동, 🚧 공사 중), 전원 준비 시스템 |
| 텍사스 홀덤 | 2~4인 | 별 서바이벌, 참가비(Ante) 라운드당 별 1개, 0별 올인 시 라운드 종료까지 카드 지급, DeltaStars 표시 |
| 세븐 포커 | 2~4인 | 4장 초이스, 히든 카드, 참가비(Ante), 0별 올인 시 라운드 종료까지 카드 지급 |
| 인디언 포커 | 1:1 | 하트 서바이벌 |
| 도둑잡기 | 2~4인 | 53장, 페어 제거, 카드 선택 후 뽑기 버튼 클릭 UX |
| 원카드 | 2~4인 | 탑 카드 매칭, 서바이벌 룰(4인 2승2패/3인 1승2패 종료), 등수별 전적 기록, C_JOKER 빨간색 강조 |

### 보드/타일 게임
| 게임 | 인원 | 비고 |
|------|------|------|
| 오목 | 1:1 | 렌주룰, 15초 타이머, 상대적 좌석, 모바일 반응형(95vw) |
